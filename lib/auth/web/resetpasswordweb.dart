...
class RestPasswordWeb extends StatefulWidget {
  String email;
  RestPasswordWeb({
    super.key,
    required this.email,
  ...
  @override
  State<RestPasswordWeb> createState() => _RestPasswordWebState();
}

class _RestPasswordWebState extends State<RestPasswordWeb> {
