...
class EditSubjectDetailsMobile extends StatefulWidget {
  String branch;
  String semester;
  String courseDtl;
  String subject;
  ...
  @override
  State<EditSubjectDetailsMobile> createState() =>
      _EditSubjectDetailsMobileState();
}

class _EditSubjectDetailsMobileState extends State<EditSubjectDetailsMobile> {
  String subjectname = '';
